...
# -----------------------
ROOT = os.path.abspath(os.path.dirname(_file_))
# BASE_MODEL_DIR = os.path.join(ROOT, "modelos", "mistral-7b-bnb-4bit") Si tienes el modelo en una carpeta
#Si tienes el modelo en la raiz del proyecto
BASE_MODEL_DIR = os.path.abspath(os.path.join(ROOT, "..", "modelos", "mistral-7b-bnb-4bit"))
LORA_ADAPTER_DIR = os.path.join(ROOT, "..", "modelos", "mistral_finetuned_miramar_combined_steps20000")
...
class MiramarSellerBot:
    def _init_(self, model, tokenizer, device="cpu"):
        self.model = model
